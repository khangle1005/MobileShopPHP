...
<div style="width:100%;">
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="item">
				<img src="img/bannerChristmas.png" alt="New York" style="width:100%;">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="hot-deal">
					...
					<p>Giảm đến 50%</p>
					<a class="primary-btn cta-btn" href="store.php?page=1">Mua sắm ngay</a>
				</div>
			</div>
		</div>
		<!-- /row -->
					...
					<div id="get_product_home2">
						...
						<div class="product-widget">
							...
							<div class="product-body">
								...
								<h4 class="product-price">980.00 đ<del class="product-old-price">980.00 đ</del></h4>
							</div>
						</div>
						<!-- /product widget -->
						...
						<div class="product-widget">
							...
							<div class="product-body">
								<p class="product-category">Category</p>
								<h3 class="product-name"><a href="#">Apple</a></h3>
								<h4 class="product-price">980.00 đ<del class="product-old-price">980.00 đ</del></h4>
							</div>
						</div>
						<!-- /product widget -->
				...
				<div class="products-widget-slick" data-nav="#slick-nav-4">
					...
					<div>
						...
						<div class="product-widget">
							...
							<div class="product-body">
								<p class="product-category">Category</p>
								<h3 class="product-name"><a href="#">Điện thoại</a></h3>
								<h4 class="product-price">980.00 đ <del class="product-old-price">980.00 đ</del></h4>
							</div>
						</div>
						<!-- /product widget -->
