...
define("SMTP_UNAME", "chdtuit@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "alo123456"); //Password for SMTP authentication
